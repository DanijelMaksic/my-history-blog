...
})({"pb9Ix":[function(require,module,exports) {
...
schemeBtn.addEventListener("click", ()=>{
    ...
    if (root.classList.contains("dark")) localStorage.setItem("selectedTheme", "dark");
    if (!root.classList.contains("dark")) localStorage.setItem("selectedTheme", "light");
});
...
if (defaultBtn) defaultBtn.classList.add("sortActive");
let getSiblings = function(currrentEl) {
    ...
    while(sibling){
        ...
        if (sibling.nodeType === 1 && sibling !== currrentEl) siblings.push(sibling);
...
},{}]},["pb9Ix","gCE4p"], "gCE4p", "parcelRequire3a3d")
